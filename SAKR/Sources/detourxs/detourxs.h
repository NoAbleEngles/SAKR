...
// ���������� �������� ��������� Windows � ������������ ����������� LPVOID, DWORD_PTR,
// PAGE_EXECUTE_READWRITE, GetModuleHandle � �.�.
#include <Windows.h>
...
#ifdef _M_IX86
#pragma comment(lib, "SAKR/Sources/detourXS/lib/LDE64.lib")
extern "C" size_t __stdcall LDE(const LPVOID lpData, unsigned int size);
#else
#pragma comment(lib, "SAKR/Sources/detourXS/lib/LDE64x64.lib")
